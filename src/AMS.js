...
//             try {
//                 const response = await axios.get('https://highersystem.onrender.com/email_users', {
//                     headers: {
...
//             }
//             try {
//                 await axios.post('https://highersystem.onrender.com/verify-token', { token });
//             } catch (error) {
...
//         try {
//             console.log(token)
//             const response = await axios.put('https://highersystem.onrender.com/update_access',
//                 {
...
//             <div className="bg-blue-600 text-white text-center py-4 rounded mb-8">
//                 <h1 className="text-xl font-semibold">Access Privileges</h1>
//             </div>
...
//                                     className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
//                                 />
//                                 <span className="ml-2 text-indigo-500 font-bold ml-5">Access Management</span>
//                             </label>
//                         </div>
...
//                                     className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
//                                 />
//                                 <span className="ml-2 text-indigo-500">Department</span>
//                             </label>
//                         </div>  */}
...
//             try {
//                 if (!hasAmsAccess) {
//                     await axios.get('https://highersystem.onrender.com/access', {
//                         // user_id: selectedEmail,
...
//             {/*************************  Header Start  ******************************/}
//             <div className="bg-custome-blue rounded-lg  mt-5 w-full p-2 flex justify-between items-center shadow-lg">
//                 <h1 className="text-white text-xl font-bold">Access Management </h1>
//                 {userData && (
...
const UpdateAccess = () => {
    ...
    const fetchUserData = async () => {
        try {
            ...
            const user = response.data.find(user_id => user_id.user_id === userIdNumber); // Compare as numbers
            if (user) {
                setUserData(user);
            } else {
                console.error(`User with ID ${storedUserId} not found in the response.`);
            }
        } catch (error) {
            console.error('Error fetching user data:', error);
        }
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-8">
            ...
            <div className="bg-custome-blue rounded-lg w-full p-3 flex justify-between items-center shadow-lg">
                ...
                <h1 className="text-white text-2xl font-bold">Access Privileges</h1>
                {userData && (
                    <div className="ml-auto flex items-center gap-4">
